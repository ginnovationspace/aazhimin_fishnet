...
async function testCreateAndVerify() {
  ...
  // Step 1: Get category
  console.log("Step 1��������⃣: Getting categories...");
  ...
  console.log("Step 2��������⃣: Creating product via API...");
  ...
  // Step 3: Wait a bit
  console.log("Step 3��������⃣: Waiting 1 second...");
  await new Promise((resolve) => setTimeout(resolve, 1000));
  console.log("��������✅ Done\n");

  // Step 4: Verify in database directly
  console.log("Step 4��������⃣: Checking database directly...");
  ...
  try {
    ...
    if (!dbProduct) {
      ...
      if (bySlug) {
        console.log(
          `��������⚠������  Found product with slug, but different ID: ${bySlug.id}`
        );
      }
    } else {
  ...
  console.log("\nStep 5��������⃣: Fetching product via API...");
