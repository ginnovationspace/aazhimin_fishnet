 ...
 * In a production environment, this integrates with Stripe.
 */
...
class PaymentService {
   ...
   * @param {string} data.paymentMethodId - Stripe payment method ID (optional)
   * @param {string[]} data.paymentMethodTypes - List of payment method types to enable (e.g., ['upi']) (optional)
   * @returns {Promise<Object>} Created payment intent and record
   */
  async createPaymentIntent(data) {
    try {
      const { marketplaceOrderId, amount, currency = "inr", paymentMethodId, paymentMethodTypes } = data;
      ...
      // Note: paymentMethodId is not required for methods like UPI where the customer authenticates via redirect
      ...
      // Attach payment method if provided (for saved cards, etc.)
      if (paymentMethodId) {
        paymentIntentParams.payment_method = paymentMethodId;
      }

      // Set payment method types or use automatic
      ...
      console.error("Error in payment service createPaymentIntent:", error);
      throw error;
    }
  }
  ...
  async confirmPayment(paymentId, paymentMethodId) {
    try {
      ...
      console.error("Error in payment service confirmPayment:", error);
      throw error;
    }
  }
  ...
  async retrievePayment(paymentId) {
    try {
      ...
      console.error("Error in payment service retrievePayment:", error);
      throw error;
    }
  }
  ...
  async refundPayment(paymentId, amount) {
    try {
      ...
      console.error("Error in payment service refundPayment:", error);
      throw error;
    }
  }
  ...
  async getPaymentStatus(paymentId) {
    try {
      ...
      console.error("Error in payment service getPaymentStatus:", error);
      throw error;
    }
  }
  ...
  async handleWebhook(payload, sig) {
    try {
      ...
      console.error("Error in payment service handleWebhook:", error);
      throw error;
    }
  }
